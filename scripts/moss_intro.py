"""Fresh-boot intro for session moss-run: raw power-on -> named player ->
overworld control -> save omp_saves/moss-intro.state. Run: .venv/bin/python
...
STATE = Path("omp_saves/moss-intro.state")
PLAYER = "MOSS"
